...
INSERT INTO "public"."banners" ("id", "cuisine", "image_url", "alt", "created_at") VALUES
	...
	('635ddc5c-25e5-454f-bbf1-41f956d22bb3', 'Mediterranean', 'https://images.unsplash.com/photo-1544124499-58912cbddaad?auto=format&fit=crop&q=80&w=1200', 'Mediterranean banner', '2026-01-31 04:12:40.147348+00') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO "public"."dishes" ("id", "cuisine", "category", "name", "description", "dietaryTags", "imageUrl", "created_at") VALUES
	...
	('f0d1e2f3-a4b5-c6d7-e8f9-a0b1c2d3e4f5', 'Mediterranean', 'Live Station', 'Falafel & Shawarma Bar', 'Freshly prepared falafel and shawarma wraps', '{veg}', NULL, '2026-01-31 04:12:40.147348+00') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO "public"."sub_menu_items" ("id", "dish_id", "name", "description", "dietaryTags", "created_at") VALUES
	...
	('f2a3b4c5-d6e7-48f9-a0b1-c2d3e4f5a6b7', 'c1a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c6', 'Sev Puri', 'Crispy base with toppings', '{veg,jain}', '2026-01-31 04:12:40.147348+00') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO "public"."profiles" ("id", "role", "email") VALUES
	...
	('f51d40d2-fc63-4c7f-b7cc-5f9ef1272fb6', 'staff', 'staff@gourmet.com') ON CONFLICT (id) DO NOTHING;
